---
title: "Assignment 11. Debugging, automation, packaging"
...
## 1. Debugging messy code (5pts)

The following code snippet contains various bugs. Identify them, remove them and report what you have done using comments. Example:

```{r, eval = FALSE}
library(tidyverse) # typo in library(Tidyverse)
```
...
## 2. Build your own minimal package (10pts)
...
Build your own package and publish it in a *public* GitHub repository. Here are the requirements:
  ...
  * I should be able to install your package using devtools::install_github("<your-github-account-name>/<your-package-name>").
  
All you have to provide in this file is one line of code:
